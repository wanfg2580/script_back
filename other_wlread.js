...
[task_local]
0 7,12,20,21 * * * other_wlread.js, tag=文旅看点, img-url=circles.hexagongrid.fill.system, enabled=true
[Script]
cron "0 7,12,20,21 * * *" script-path=other_wlread.js,tag=文旅看点
*/
...
$.post(other_wlread('article/read',hd,md5('bKZ7WjF370'+token+Brand+Model+timestamp+'bKZ7WjF370')), async (err, resp, data) => {
...
$.post(other_wlread('article/list',hd,md5('bKZ7WjF370'+token+Brand+Model+timestamp+'bKZ7WjF370')), async (err, resp, data) => {
       //console.log(data)
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
...
$.post(other_wlread('share/info',hd,md5('bKZ7WjF370'+token+Brand+Model+timestamp+'bKZ7WjF370')), async (err, resp, data) => {
      //console.log(data)
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
...
$.post(other_wlread('hottask/info',hd,md5('bKZ7WjF370'+token+Brand+Model+timestamp+'bKZ7WjF370')), async (err, resp, data) => {
...
$.post(other_wlread('hottask/profit',hd,md5('bKZ7WjF370'+token+Brand+Model+timestamp+'bKZ7WjF370')), async (err, resp, data) => {
...
function other_wlread(a, body, sppid) {
    hds =  JSON.parse(wlhd)
    //sppid = hds.sppid
  return {
